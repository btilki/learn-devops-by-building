...
**Lab root:** `books/practical-engineering/labs/platform/northwind/`  
...
Reduced fixtures must be generated deliberately and reviewed. No test may read from `books/practical-engineering/labs/devops/northwind/` or `books/practical-engineering/labs/devsecops/northwind/` at runtime.
