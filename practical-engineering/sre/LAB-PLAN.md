...
**Lab root:** `books/practical-engineering/labs/sre/northwind/`  
...
Reduced fixtures must be generated deliberately and reviewed. No test may read from `books/practical-engineering/labs/devops/northwind/`, `books/practical-engineering/labs/devsecops/northwind/`, or `books/practical-engineering/labs/platform/northwind/` at runtime.
...
```text
books/practical-engineering/labs/sre/northwind/
├── Makefile
├── README.md
├── pyproject.toml
├── inherited/
