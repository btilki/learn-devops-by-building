...
**Lab root:** `books/labs/devsecops/northwind/`  
...
Reduced fixtures must be generated deliberately and reviewed. They must not be described as exact copies. No test may read from `books/labs/devops/northwind/` at runtime.
